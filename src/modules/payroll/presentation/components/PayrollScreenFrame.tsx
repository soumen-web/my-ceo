...
import type { AppDrawerParamList, PayrollStackParamList } from '@/navigation/route-types';
...
interface PayrollScreenFrameProps {
  isDetail?: boolean;
...
export const PayrollScreenFrame = ({
  children,
  isDetail = false,
  navigation,
  onRefresh,
  ...
  routeLabel = 'Payroll',
  title,
}: PropsWithChildren<PayrollScreenFrameProps>) => {
