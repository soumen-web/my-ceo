...
import type { AppDrawerParamList, LeaveStackParamList } from '@/navigation/route-types';
import { ROUTES } from '@/navigation/route-types';
import { fontSize, spacing } from '@/utils/scale';

type LeaveNavigation = NavigationProp<LeaveStackParamList>;
const moduleColors = reactNativeColorScheme.ultiHuman.module;

interface LeaveScreenFrameProps {
  isDetail?: boolean;
...
export const LeaveScreenFrame = ({
  ...
  routeLabel = 'Leave',
  title,
}: PropsWithChildren<LeaveScreenFrameProps>) => {
